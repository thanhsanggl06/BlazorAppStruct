...
[ApiController]
[Route("api/todo-ef")] // EF demo route
public class TodoEfController(ITodoEfService service) : ControllerBase
{
    [HttpGet]
    ...
    [HttpGet("paged")] // /api/todo-ef/paged?pageNumber=1&pageSize=20&search=abc
