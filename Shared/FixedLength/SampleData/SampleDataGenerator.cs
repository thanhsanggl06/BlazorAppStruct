...
/// <summary>
/// Generator cho sample data để demo
/// </summary>
public static class SampleDataGenerator
{
    ...
    { 
        "Thanh toán hóa đơn", "Nạp tiền", "Chuyển khoản", "Rút tiền", 
        "Mua hàng", "Đặt cọc", "Hoàn tiền", "Thanh toán phí"
    };
        ...
        return Enumerable.Range(1, count)
            .Select(i =>
            {
                ...
                return new InvoiceRecord
                {
                    ...
                    Notes = isPaid ? "Đã thanh toán đầy đủ" : null
                };
            })
